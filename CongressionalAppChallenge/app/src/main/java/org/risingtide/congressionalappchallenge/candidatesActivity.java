...
public class candidatesActivity extends HomeScreenActivity{
    ...
    public void onClickCandidate(View view){
        ...
        // Sets fileToLoad(static) to the layout that is the app is going to switch to.
            ...
            case(R.id.warrenPic):
                // Sets fileToLoad(static) to the layout that is the app is going to switch to.
                individualCandidates.fileToLoad = R.layout.warren;
                switchScreen = new Intent(this, individualCandidates.class);
                startActivity(switchScreen);
                break;
            case(R.id.diehlPic):
                // Sets fileToLoad(static) to the layout that is the app is going to switch to.
                individualCandidates.fileToLoad = R.layout.diehl;
                switchScreen = new Intent(this, individualCandidates.class);
                startActivity(switchScreen);
                break;
            case(R.id.ayyaduraiPic):
                // Sets fileToLoad(static) to the layout that is the app is going to switch to.
                individualCandidates.fileToLoad = R.layout.ayyadurai;
                switchScreen = new Intent(this, individualCandidates.class);
                startActivity(switchScreen);
                break;
            case(R.id.ballotButton):
                ballotQuestions.fileToLoad = R.layout.ballot_questions;
                switchScreen = new Intent(this, ballotQuestions.class);
                startActivity(switchScreen);
                break;
    }
